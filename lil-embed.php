 ...
 */
add_action( 'init', 'lilembed_load_textdomain' );

function lilembed_load_textdomain() {
	load_plugin_textdomain( 'lilembed', false, basename( __DIR__ ) . '/languages' );
}
 ...
 */
add_action( 'init', 'lilembed_register_blocks' );

function lilembed_register_blocks() {
	...
	foreach( $blocks as $block ) {
		register_block_type( $block, array(
			'editor_script' => 'lilembed-editor-script',					// Calls registered script above
			'editor_style' => 'lilembed-editor-styles',					// Calls registered stylesheet above
			'style' => 'lilembed-front-end-styles',						// Calls registered stylesheet above
		) );	  
	}
	 ...
	 */
	wp_set_script_translations( 'lilembed-editor-script', 'lilembed', plugin_dir_path( __FILE__ ) . '/languages' );
	}
